...
\end{center}
\columnbreak
K(i,J) = il valore massimo che posso ottenere considerando i primi i oggetti, avendo uno zaino di capacità J. E si dice che è il massimo con K di  i-1 con lo stesso spazio, oppure devo aggiungere il mio valore ma devo avere spazio sufficente, quindi \textbf{guardo alla migliore risposta senza il mio peso, per questo K(i-1,J-w\_i)}
\end{multicols}
